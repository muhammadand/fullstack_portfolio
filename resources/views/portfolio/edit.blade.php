                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            ...
                            <input type="text" name="title" id="titleInput" value="{{ old('title', $item->title) }}"
                                required placeholder="Masukkan judul portfolio..."
                            ...
                            <input type="text" name="slug" id="slugInput" value="{{ old('slug', $item->slug) }}"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <div id="thumbnailPreview"
                                            class="{{ $item->thumbnail_image ? '' : 'hidden' }} mb-3">
                                            <img id="thumbnailImg"
                                                src="{{ $item->thumbnail_image ? asset('storage/' . $item->thumbnail_image) : '' }}"
                                                class="w-full h-32 object-cover rounded-lg" alt="Thumbnail">
                                        ...
                                        <label for="thumbnailInput" id="thumbnailUploadArea"
                                            class="{{ $item->thumbnail_image ? 'hidden' : '' }} flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all">
                                        ...
                                        <input type="file" name="thumbnail_image" id="thumbnailInput" accept="image/*"
                                            class="hidden">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <div id="featuredPreview" class="{{ $item->featured_image ? '' : 'hidden' }} mb-3">
                                            <img id="featuredImg"
                                                src="{{ $item->featured_image ? asset('storage/' . $item->featured_image) : '' }}"
                                                class="w-full h-32 object-cover rounded-lg" alt="Featured">
                                        ...
                                        <label for="featuredInput" id="featuredUploadArea"
                                            class="{{ $item->featured_image ? 'hidden' : '' }} flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all">
                                            <svg class="w-8 h-8 mb-1 text-gray-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            ...
                            <textarea name="short_description" rows="2" required
                                ...
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('short_description', $item->short_description) }}</textarea>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <textarea name="challenge" rows="2" placeholder="Masalah atau tantangan yang dihadapi..."
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('challenge', $item->challenge) }}</textarea>
                                </div>
                                <div>
                                    ...
                                    <textarea name="solution" rows="2" placeholder="Bagaimana Anda menyelesaikan masalah..."
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('solution', $item->solution) }}</textarea>
                                </div>
                                <div>
                                    ...
                                    <textarea name="result" rows="2" placeholder="Hasil yang dicapai dari proyek ini..."
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('result', $item->result) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="project_type"
                                        value="{{ old('project_type', $item->project_type) }}"
                                ...
                                <div class="pt-3 border-t border-gray-200 space-y-3">
                                    <div>
                                        ...
                                        <input type="url" name="project_url"
                                            value="{{ old('project_url', $item->project_url) }}"
