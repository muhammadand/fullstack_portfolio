...
<div class="max-w-3xl mx-auto px-6 py-10">
    {{-- ✅ Header --}}
    <h2 class="text-3xl font-bold gradient-text mb-6">Edit Kategori Blog</h2>
    ...
    {{-- ✅ Form --}}
    <form action="{{ route('blog-categories.update', $category->id) }}" method="POST" class="bg-white p-6 rounded-xl shadow-md flex flex-col gap-4">
        @csrf
        @method('PUT')
