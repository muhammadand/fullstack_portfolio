    ...
    <div class="w-full max-w-7xl h-full max-h-[900px] bg-white rounded-3xl shadow-2xl flex overflow-hidden">
        ...
        <div class="hidden lg:flex lg:w-1/2 items-center justify-center p-16 relative bg-gradient-to-br from-purple-50 to-blue-50">
            ...
            <div class="relative z-10">
                ...
                <!-- Checkmark Circle -->
                <div class="checkmark-circle absolute -top-8 -left-8 w-20 h-20 rounded-full flex items-center justify-center z-20">
                ...
                <!-- Document -->
                <div class="absolute -bottom-8 -left-12 w-20 h-28 bg-white rounded-xl shadow-2xl z-20">
                    <div class="p-3 space-y-2">
                        <div class="h-1 bg-gray-300 rounded w-12"></div>
                        <div class="h-1 bg-gray-200 rounded w-10"></div>
                        <div class="h-1 bg-gray-200 rounded w-14"></div>
                    </div>
                </div>
                
                <!-- Additional Card/Paper -->
                <div class="absolute bottom-12 -right-6 w-24 h-16 bg-gradient-to-br from-red-400 to-pink-500 rounded-lg shadow-xl transform rotate-12"></div>
            </div>
        </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <!-- Sign In Button -->
                        <div class="flex items-center gap-2">
                            <span class="text-xs text-gray-500 hidden sm:inline">Already have an account?</span>
                            <a href="{{ route('login') }}" class="text-xs font-medium text-gray-700 border border-gray-300 px-3 py-1.5 rounded-lg hover:bg-gray-50 transition">
                                SIGN IN
                            </a>
                        </div>
                    </div>

                    <h1 class="text-3xl font-bold text-gray-900 mb-1">Welcome to Focus!</h1>
                    <p class="text-gray-500 text-sm">Register your account</p>
                </div>
                ...
                <form action="{{ route('register.post') }}" method="POST" class="space-y-4">
                    ...
                    <!-- Name -->
                    <div>
                        <label class="block text-gray-700 font-medium mb-1.5 text-sm">Name</label>
                        <input type="text" name="name" value="{{ old('name') }}"
                               class="w-full border-2 border-indigo-500 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-100 transition text-gray-900 text-sm"
                               placeholder="Ch">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="role" class="w-full border-2 border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition text-gray-700 text-sm">
