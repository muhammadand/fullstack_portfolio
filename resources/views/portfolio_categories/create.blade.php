...
<div class="max-w-3xl mx-auto px-6 py-10">
    <h2 class="text-3xl font-bold mb-6 gradient-text">Tambah Kategori Portfolio</h2>

    <form action="{{ route('portfolio-categories.store') }}" method="POST" class="space-y-6 bg-white p-8 rounded-2xl shadow-md">
        @csrf
