...
@section('content')
    <section class="relative min-h-screen flex flex-col items-center justify-center pt-16 overflow-hidden">
        ...
        <div class="absolute top-24 right-8 md:right-24 animate-float-slow opacity-80">
            <div class="w-16 h-16 md:w-24 md:h-24 relative">
                ...
                <svg viewBox="0 0 80 80" class="w-full h-full drop-shadow-lg" fill="none">
                    ...
                    <path d="M40 12 C52 20 58 30 54 44 L46 48 L44 56 L36 56 L34 48 L26 44 C22 30 28 20 40 12Z"
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center mt-10">
            <div
                class="mb-6 flex items-center gap-2 bg-white/10 border border-white/15 rounded-full px-4 py-1.5 text-sm backdrop-blur-sm">
            ...
            <div
                ...
                <div
                    ...
                    <p class="text-white/40 text-[10px] mb-1">Metode: Automasi Alur Kerja</p>
                    <div class="flex items-end gap-2 mb-4">
                        <span class="font-display text-3xl font-bold text-white">+85%</span>
                        <span
                            class="text-[10px] bg-emerald-500/20 text-emerald-400 border border-emerald-400/30 rounded-full px-2 py-0.5 mb-1.5">↑
                            Meningkat</span>
                    </div>
                    <div class="space-y-2 border-t border-white/5 pt-3">
                        <div class="h-7 bg-white/5 rounded-full border border-white/5 flex items-center px-2 gap-2">
                            <div class="w-3 h-3 rounded-full bg-brand-accent/60"></div>
                            <div class="h-1.5 w-16 bg-white/20 rounded-full"></div>
                        </div>
                        <div class="h-7 bg-white/5 rounded-full border border-white/5 flex items-center px-2 gap-2 w-4/5">
                ...
                <div
                    class="relative w-64 sm:w-72 bg-gradient-to-b from-white/15 to-white/5 border border-white/20 rounded-[2rem] p-6 shadow-card backdrop-blur-xl z-30 animate-float-slow">
                    <div class="text-center mb-5">
                        <span
                            class="inline-block bg-brand-accent/20 text-brand-accent border border-brand-accent/30 text-[9px] font-bold px-2 py-1 rounded-full mb-3 tracking-wider">SCALIFY
                            AI ENGINE</span>
                        <p class="font-display text-xl font-bold leading-tight mt-1 text-white">Menganalisis
                            Data<br />Pelanggan Real-Time</p>
                    </div>
                    ...
                    <div class="flex items-center gap-4 mb-5 bg-black/20 rounded-2xl p-3 border border-white/5">
                        <div class="relative w-14 h-14 flex-shrink-0">
                            <svg class="w-full h-full -rotate-90" viewBox="0 0 48 48">
                                <circle cx="24" cy="24" r="20" fill="none" stroke="rgba(255,255,255,0.1)"
                                    stroke-width="4" />
                                <circle cx="24" cy="24" r="20" fill="none" stroke="#3B82F6"
                                    stroke-width="4" stroke-dasharray="125.6" stroke-dashoffset="10"
                                    stroke-linecap="round" />
                            </svg>
                            <span
                                class="absolute inset-0 flex items-center justify-center font-bold text-sm text-white">92%</span>
                        </div>
                        <p class="text-white/70 text-xs leading-snug">Klasterisasi <strong
                                class="text-brand-accent">K-Means</strong> aktif untuk segmentasi pasar 🔥</p>
                    </div>

                    <div class="w-full bg-black/30 rounded-xl p-3 border border-white/5">
                        <div class="flex items-center justify-between mb-3">
                            <span class="text-[10px] text-white/50 font-medium">Live Processing</span>
                        ...
                        <div class="space-y-2.5">
                            <div class="flex items-center gap-2">
                                <div class="w-5 h-5 rounded bg-blue-500/20 flex items-center justify-center text-[10px]">
                                    👤</div>
                                <div class="flex-1 h-1.5 bg-white/5 rounded-full overflow-hidden">
                                    <div class="h-full bg-blue-400 w-3/4 animate-pulse"></div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-5 h-5 rounded bg-indigo-500/20 flex items-center justify-center text-[10px]">
                                    💳</div>
                                <div class="flex-1 h-1.5 bg-white/5 rounded-full overflow-hidden">
                                    <div class="h-full bg-indigo-400 w-1/2 animate-pulse" style="animation-delay: 150ms;">
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-5 h-5 rounded bg-purple-500/20 flex items-center justify-center text-[10px]">
                                    📊</div>
                                <div class="flex-1 h-1.5 bg-white/5 rounded-full overflow-hidden">
                                    <div class="h-full bg-purple-400 w-5/6 animate-pulse" style="animation-delay: 300ms;">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="animate-float md:absolute md:right-0 md:translate-x-4 md:top-14 w-56 bg-gradient-to-br from-white/15 to-white/5 border border-white/15 rounded-2xl p-4 shadow-card backdrop-blur-md z-20"
                    style="animation-delay: 2s;">
                    <div class="flex items-center gap-2 mb-2">
                        <span
                            class="flex items-center justify-center w-4 h-4 rounded-full bg-emerald-500/20 text-[8px] text-emerald-400">✓</span>
                        <p class="text-[10px] text-white/60 font-medium">Forecasting C45</p>
                    </div>
                    <p class="font-display text-xl font-bold leading-tight mb-1 text-white">Prediksi Tren<br /><span
                            class="text-brand-accent">Sangat Akurat</span></p>

                    <div class="mt-4 h-14 w-full flex items-end gap-1.5 pt-2 border-t border-white/5">
                        <div class="w-1/6 bg-white/10 rounded-t-sm h-1/3 hover:bg-white/20 transition-colors"></div>
                        <div class="w-1/6 bg-white/10 rounded-t-sm h-1/2 hover:bg-white/20 transition-colors"></div>
                        <div class="w-1/6 bg-white/10 rounded-t-sm h-2/3 hover:bg-white/20 transition-colors"></div>
                        <div class="w-1/6 bg-brand-blue/50 rounded-t-sm h-3/4 hover:bg-brand-blue/70 transition-colors">
                        </div>
                        <div class="w-1/6 bg-brand-accent/80 rounded-t-sm h-4/5 hover:bg-brand-accent transition-colors">
                        </div>
                        <div class="w-1/6 bg-brand-accent rounded-t-sm h-full relative">
                            <div
                                class="absolute -top-1.5 -right-1 w-3 h-3 bg-white rounded-full shadow-[0_0_10px_rgba(255,255,255,0.9)] z-10">
                            </div>
                            <div class="absolute -top-1.5 -right-1 w-3 h-3 bg-white rounded-full animate-ping opacity-75">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div
            class="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-brand-dark/0 via-brand-dark/50 to-brand-dark pointer-events-none">
        </div>
    </section>
    ...
    <section class="py-8 bg-white border-b border-slate-100 overflow-hidden relative z-20">
        ...
        <div
            class="absolute inset-y-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none mt-12">
        </div>
        <div
            class="absolute inset-y-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none mt-12">
        </div>
        ...
        <div class="flex w-max animate-infinite-scroll hover:[animation-play-state:paused]">
            ...
            <div class="flex gap-12 sm:gap-16 items-center px-6 sm:px-8">
                <!-- Laravel -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#FF2D20] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-brands fa-laravel text-3xl"></i>
                    <span class="font-display font-bold text-lg">Laravel</span>
                </div>
                <!-- MySQL -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#4479A1] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-solid fa-database text-2xl"></i>
                    <span class="font-display font-bold text-lg">MySQL</span>
                </div>
                <!-- Node.js -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#339933] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-brands fa-node-js text-3xl"></i>
                    <span class="font-display font-bold text-lg">Node.js</span>
                </div>
                <!-- Python -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#3776AB] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-brands fa-python text-3xl"></i>
                    <span class="font-display font-bold text-lg">Python</span>
                </div>
                <!-- PostgreSQL -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#336791] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-solid fa-database text-2xl"></i>
                    <span class="font-display font-bold text-lg">PostgreSQL</span>
                </div>
                <!-- Flowise -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-brand-accent transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-solid fa-robot text-2xl"></i>
                    <span class="font-display font-bold text-lg">Flowise</span>
                </div>
                <!-- Redis -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#DC382D] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-solid fa-server text-2xl"></i>
                    <span class="font-display font-bold text-lg">Redis</span>
                </div>
                <!-- VPS -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-slate-700 transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
                    <i class="fa-solid fa-cloud text-2xl"></i>
                    <span class="font-display font-bold text-lg">VPS Server</span>
                </div>
                <!-- Docker -->
                <div
                    class="flex items-center gap-3 text-slate-400 hover:text-[#2496ED] transition-colors duration-300 cursor-default grayscale hover:grayscale-0">
    ...
    <section id="services" class="bg-[#f8fafc] text-slate-800 py-16 px-4 sm:px-6 lg:px-8 relative z-20">
        <div class="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-center lg:items-start">
            ...
            <div
                ...
                <a href="https://wa.me/6285221694067" target="_blank"
                    class="bg-btn-gradient shadow-glow-sm hover:shadow-glow-blue text-white text-sm font-semibold px-6 py-3 rounded-full hover:-translate-y-1 transition-all duration-300 flex items-center gap-2">
            ...
            <div class="lg:w-[60%] grid grid-cols-1 sm:grid-cols-2 gap-5 w-full">
                <!-- Kartu 1 -->
                <div
                    class="bg-btn-gradient text-white rounded-[1.5rem] p-6 sm:p-7 shadow-glow-sm hover:shadow-glow-blue hover:-translate-y-1.5 transition-all duration-300 h-full flex flex-col group border border-white/10">
                    <div
                        class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <!-- Kartu 2 -->
                <div
                    class="bg-white border border-slate-100 text-slate-800 rounded-[1.5rem] p-6 sm:p-7 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1.5 transition-all duration-300 h-full flex flex-col group">
                    <div
                        class="w-12 h-12 bg-btn-gradient rounded-full flex items-center justify-center mb-6 shadow-glow-sm group-hover:scale-110 transition-transform duration-300">
    ...
    <section id="portofolio" class="bg-[#f8fafc] py-24 px-4 sm:px-6 lg:px-8 border-t border-slate-100 overflow-hidden"
        x-data="{}">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
                <div class="max-w-xl">
                    <h2
                        class="font-display text-3xl sm:text-4xl font-semibold text-slate-900 leading-[1.15] tracking-tight mb-2">
            ...
            <div class="relative w-full group">
                <!-- Carousel Container -->
                <div x-ref="slider"
                    class="flex gap-5 sm:gap-6 overflow-x-auto snap-x snap-mandatory pb-8 pt-4 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0"
                    style="scrollbar-width: none; -ms-overflow-style: none;">

                    <!-- Card 1 -->
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            class="relative w-full rounded-[1.5rem] overflow-hidden bg-black shadow-md transition-all duration-300 group-hover/card:shadow-xl group-hover/card:shadow-slate-300 group-hover/card:-translate-y-1 border border-slate-200">
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/iUJWNHxI2RU" title="YouTube video player"
                                frameborder="0"
                    ...
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            ...
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/-bkn_ignjD4" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            ...
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/kMWZS8c5Xuo" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            ...
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/tO4PwTDOLX8" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            ...
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/mG9gcUFLMeM" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="shrink-0 w-[280px] sm:w-[360px] snap-center group/card">
                        <div
                            ...
                            <div style="padding-top: 56.25%;"></div>
                            <iframe class="absolute top-0 left-0 w-full h-full"
                                src="https://www.youtube.com/embed/9vuxrTVfRNo" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                ...
                <div class="flex items-center justify-between mt-2">
                    <a href="https://www.youtube.com/" target="_blank"
                        class="bg-btn-gradient text-white font-medium px-6 py-3 rounded-full shadow-glow-sm hover:shadow-glow-blue hover:-translate-y-1 transition-all duration-300 text-sm flex items-center gap-2">
                        Buka YouTube <i class="fa-solid fa-arrow-up-right-from-square text-xs"></i>
                    </a>

                    <div class="flex items-center gap-3">
                        <button @click="$refs.slider.scrollBy({left: -360, behavior: 'smooth'})"
                            class="w-12 h-12 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-slate-50 hover:text-brand-blue transition-colors shadow-sm">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col h-full">
                    ...
                    <a href="https://wa.me/6285221694067?text=Halo%20Scalify,%20saya%20tertarik%20dengan%20Paket%20Digital%20Presence"
                        target="_blank"
                        class="w-full py-3 rounded-xl border border-white/20 text-center text-sm font-semibold hover:bg-white/10 transition-colors">Pilih
                        Paket</a>
                </div>

                <div
                    class="relative bg-gradient-to-br from-blue-600/20 to-indigo-700/20 border border-brand-accent/50 rounded-2xl p-6 flex flex-col h-full transform md:-translate-y-4 shadow-glow-sm">
                    <div
                        class="absolute top-0 right-0 bg-brand-accent text-brand-dark text-[10px] font-bold px-3 py-1 rounded-bl-lg rounded-tr-xl">
                        POPULER</div>
                    ...
                    <a href="https://wa.me/6285221694067?text=Halo%20Scalify,%20saya%20tertarik%20dengan%20Paket%20Smart%20Automation"
                        target="_blank"
                        class="w-full py-3 rounded-xl bg-btn-gradient text-white text-center text-sm font-semibold hover:shadow-glow-blue transition-all">Pilih
                        Paket</a>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col h-full">
                    ...
                    <a href="https://wa.me/6285221694067?text=Halo%20Scalify,%20saya%20tertarik%20dengan%20Paket%20Intelligence%20%26%20Data"
                        target="_blank"
                        class="w-full py-3 rounded-xl border border-white/20 text-center text-sm font-semibold hover:bg-white/10 transition-colors">Konsultasi
                        Khusus</a>
                </div>
            </div>
        </div>
