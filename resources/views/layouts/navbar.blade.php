    <nav class="fixed top-0 left-0 right-0 z-50 bg-brand-dark/80 backdrop-blur-xl border-b border-white/5">
        <div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-14 sm:h-16">
            ...
            <div class="flex items-center gap-1.5 sm:gap-2 cursor-pointer" onclick="window.scrollTo(0,0)">
                ...
                <span class="font-display font-bold text-base sm:text-lg tracking-tight">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <a href="https://wa.me/6285221694067" target="_blank" class="bg-btn-gradient text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-full shadow-glow-sm hover:shadow-glow-blue transition-all">
                    Hubungi Kami
                </a>

                {{-- Hamburger Button (mobile only) --}}
                <button id="nav-toggle" aria-label="Toggle menu" aria-expanded="false" class="md:hidden flex items-center justify-center w-8 h-8 rounded-md focus:outline-none text-white">
                    {{-- Hamburger icon --}}
                    <svg id="icon-open" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="width:1.25rem;height:1.25rem;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    {{-- X / Close icon (hidden by default) --}}
                    <svg id="icon-close" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="width:1.25rem;height:1.25rem;display:none;">
