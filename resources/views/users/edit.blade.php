        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input type="password" name="password" class="w-full border border-slate-300 rounded-lg px-4 py-2 focus:ring focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                ...
                <div class="col-span-1">
                    ...
                    <input type="password" name="password_confirmation" class="w-full border border-slate-300 rounded-lg px-4 py-2 focus:ring focus:ring-blue-200 focus:border-blue-500 outline-none transition">
                </div>
