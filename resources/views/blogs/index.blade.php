                        ...
                        <tr class="border-b hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4">
                                @if ($blog->is_published)
                                    <span
                                        class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">Published</span>
                                @else
                                    <span
                                        class="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-semibold">Draft</span>
                                @endif
                            </td>
