            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6">
                        ...
                        <input type="text" name="title" id="titleInput" value="{{ old('title') }}" required placeholder="Masukkan judul blog yang menarik (jika kosong AI akan membuat random)..." class="w-full text-base font-semibold border-0 border-b-2 border-gray-200 px-0 py-2 focus:border-slate-800 focus:ring-0 placeholder-gray-400">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6">
                        ...
                        <div class="relative">
                            <div id="imagePreview" class="hidden mb-3">
                                ...
                                <button type="button" id="removeImage" class="absolute top-2 right-2 bg-red-500 text-white p-1.5 rounded-full hover:bg-red-600 transition-colors">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6">
                        ...
                        <textarea name="excerpt" id="excerptInput" rows="2" placeholder="Ringkasan singkat artikel (otomatis diambil dari konten jika kosong)" class="w-full border border-gray-300 rounded-xl px-3 py-2 text-[13px] focus:ring-2 focus:ring-slate-800 focus:border-transparent resize-none">{{ old('excerpt') }}</textarea>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 lg:sticky lg:top-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="tags[]" value="{{ old('tags') ? implode(',', old('tags')) : '' }}" placeholder="Laravel, Tutorial, Web" class="w-full border border-gray-300 rounded-xl px-3 py-2 text-[13px] focus:ring-2 focus:ring-slate-800 focus:border-transparent">
                            ...
                            <div class="pt-3 border-t border-gray-200 space-y-3">
                                <div>
                                    ...
                                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" placeholder="Otomatis dari judul jika kosong" class="w-full border border-gray-300 rounded-xl px-3 py-2 text-[13px] focus:ring-2 focus:ring-slate-800 focus:border-transparent">
                                </div>
                                <div>
                                    <label class="block text-[13px] font-medium tracking-wide text-slate-700 text-gray-700 mb-1.5">Meta Description</label>
                                    <textarea name="meta_description" rows="2" placeholder="Otomatis dari excerpt jika kosong" class="w-full border border-gray-300 rounded-xl px-3 py-2 text-[13px] focus:ring-2 focus:ring-slate-800 focus:border-transparent resize-none">{{ old('meta_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="pt-3 border-t border-gray-200 space-y-2">
                                <label class="flex items-center justify-between cursor-pointer">
                                    ...
                                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-slate-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-slate-900">
                                </label>

                                <label class="flex items-center justify-between cursor-pointer">
                                    <span class="text-[13px] font-medium tracking-wide text-slate-700 text-gray-700">Publikasikan</span>
                                    <input type="checkbox" name="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-slate-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-slate-900">
                                </label>
                            </div>
                        </div>
