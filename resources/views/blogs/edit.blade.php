                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            ...
                            <input type="text" name="title" id="titleInput" value="{{ old('title', $blog->title) }}"
                                required placeholder="Masukkan judul blog yang menarik..."
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="relative inline-block">
                                        <img src="{{ asset('storage/' . $blog->featured_image) }}"
                                            class="w-full h-48 object-cover rounded-lg" alt="Current image">
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="relative">
                                <div id="imagePreview" class="hidden mb-3">
                                    ...
                                    <button type="button" id="removeImage"
                                        class="absolute top-8 right-2 bg-red-500 text-white p-1.5 rounded-full hover:bg-red-600 transition-colors">
                                ...
                                <label for="imageInput" id="imageUploadArea"
                                    ...
                                    <p class="text-sm text-gray-600"><span
                                            class="font-medium">{{ $blog->featured_image ? 'Ganti gambar' : 'Klik untuk upload' }}</span>
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            ...
                            <textarea name="excerpt" id="excerptInput" rows="2"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none">{{ old('excerpt', $blog->excerpt) }}</textarea>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tags[]"
                                        value="{{ old('tags') ? implode(',', old('tags')) : (is_array($blog->tags) ? implode(',', $blog->tags) : $blog->tags) }}"
                                ...
                                <div class="pt-3 border-t border-gray-200 space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="meta_description" rows="2" placeholder="Otomatis dari excerpt jika kosong"
                                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                    </div>
                                </div>
        ...
        document.getElementById('linkInsert').addEventListener('click', () => {
            if (linkText.value && linkHref.value) {
                ...
                if (range) {
                    ...
                    quill.insertText(range.index, linkText.value, {
                        link: linkHref.value
                    });
                }
            }
