...
@section('content')
    <section id="home" class="relative min-h-screen flex items-center pt-32 pb-20 px-6 overflow-hidden bg-gray-50">
        ...
        <!-- Background Elements -->
        <div
            class="absolute top-1/4 right-0 w-96 h-96 bg-gradient-to-br from-purple-400 to-blue-500 rounded-full opacity-20 blur-3xl">
        </div>
        <div
            class="absolute bottom-1/4 left-0 w-80 h-80 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full opacity-15 blur-3xl">
        </div>
        ...
        <div class="max-w-7xl mx-auto w-full relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <h1 class="text-5xl lg:text-6xl font-bold mb-6 leading-tight text-gray-900">
                        ...
                        <span class="relative inline-block">
                            <span
                                class="relative z-10 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Tujuan</span>
                        ...
                        <span class="relative inline-block">
                            <span
                                class="relative z-10 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Hati</span>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-8">
                        <div class="flex items-start gap-3">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                        ...
                        <div class="flex items-start gap-3">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                        ...
                        <div class="flex items-start gap-3">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                        ...
                        <div class="flex items-start gap-3">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                    ...
                    <div class="flex flex-wrap gap-4 mb-8">
                        <a href="#contact"
                            class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                            Mulai Sekarang
                            <i class="fas fa-arrow-right"></i>
                        </a>
                        <a href="#portfolio"
                            class="inline-flex items-center gap-2 border-2 border-purple-600 text-purple-600 px-8 py-4 rounded-xl font-semibold hover:bg-purple-50 transition-all duration-300">
                            Lihat Portfolio
                ...
                <div class="order-1 lg:order-2 relative">
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-purple-600 via-purple-500 to-blue-600 rounded-3xl transform rotate-3">
                        </div>
                        ...
                        <div
                            ...
                            <img src="{{ asset('foto.jpg') }}" alt="Muhammad Andi Mubarok"
                                class="w-full h-[500px] object-cover">
                        </div>

                        <!-- Floating Elements -->
                        <div class="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-xl p-3 animate-bounce"
                        ...
                        <div class="absolute -top-4 -right-4 bg-white rounded-xl shadow-xl p-3 animate-bounce"
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 pt-12 border-t border-gray-200">
                <div class="text-center group">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="text-center group">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="text-center group">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="text-center group">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-100 to-pink-200 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
