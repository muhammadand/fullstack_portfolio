        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                                ...
                                <a href="{{ route('portfolio.read', $portfolio->slug) }}">
                                    ...
                                    @if ($firstTech)
                                        <div class="absolute top-4 left-4">
                                            <span
                                                class="px-3 py-1.5 text-xs font-semibold rounded-full bg-purple-600/90 text-white uppercase tracking-wide backdrop-blur-sm">
                                                {{ $firstTech }}
                                            </span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-6">
                                        <h2
                                            class="text-2xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors duration-300">
                                            {{ $portfolio->title }}
                                        </h2>
                                    ...
                                    <div
                                        class="absolute inset-0 bg-purple-600/0 group-hover:bg-purple-600/20 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div
                                            class="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                            <span
                                                class="inline-flex items-center gap-2 px-6 py-3 bg-white text-purple-600 font-bold rounded-full shadow-lg">
                                                View Project
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-8">
                    ...
                    <div
                        class="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-6 shadow-lg border border-purple-100">
                                    ...
                                    <a href="{{ route('portfolio.read', $popular->slug) }}"
                                        ...
                                        <div class="flex gap-3 p-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h4
                                                    class="font-semibold text-gray-900 group-hover:text-purple-600 transition-colors line-clamp-2 mb-2">
                                                    {{ $popular->title }}
                                                </h4>
                    ...
                    <!-- Call to Action -->
                    <div
                        class="mt-6 bg-gradient-to-br from-purple-600 to-indigo-700 rounded-2xl p-6 shadow-lg text-white text-center">
                        ...
                        <a href="#contact"
                            class="inline-block bg-white text-purple-600 px-6 py-2 rounded-full font-semibold hover:bg-purple-50 transition-colors">
                            Get Started
                        </a>
                    </div>
                </div>
