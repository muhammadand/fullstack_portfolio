                    ...
                    @if ($portfolio->technologies && count($portfolio->technologies))
                        <div class="flex flex-wrap gap-2 mb-4">
                            @foreach ($portfolio->technologies as $tech)
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full bg-purple-600/80 text-white uppercase tracking-wide backdrop-blur-sm">
                                    {{ $tech }}
                                </span>
                            @endforeach
                        </div>
                        ...
                        @foreach ($popularPortfolios as $popular)
                            <a href="{{ route('portfolio.read', $popular->slug) }}"
                                ...
                                <div class="relative h-64 overflow-hidden">
                                    ...
                                    <!-- Hover Effect -->
                                    <div
                                        class="absolute inset-0 bg-purple-600/0 group-hover:bg-purple-600/20 transition-all duration-300">
                                    </div>
                                </div>
                            </a>
                        @endforeach
