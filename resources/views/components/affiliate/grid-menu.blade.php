...
<div class="grid grid-cols-4 gap-y-6 gap-x-2 mb-8">
    ...
    <!-- 5. Project Deal -->
    <a href="{{ route('affiliate.history') }}" class="flex flex-col items-center gap-2">
        <div class="w-12 h-12 rounded-2xl glass-panel flex items-center justify-center text-emerald-400 text-lg shadow-inner transition-transform active:scale-95">
    ...
    <!-- 6. Tulis Artikel -->
    <a href="{{ route('affiliate.blogs.index') }}" class="flex flex-col items-center gap-2">
        ...
        <span class="text-[10px] text-slate-300 font-medium text-center leading-tight">Tulis<br>Artikel</span>
    </a>
