...
file_path = '/Users/muhammadandi/Project web/fullstack_portfolio/resources/views/portfolio/edit.blade.php'
...
print("Updated portfolio edit.blade.php successfully")
